...
VICTORY_PATH = BASE_DIR / "victory.html"
# The electoral map SVG is generated by tools/generate_map.py and inlined into
# index.html and victory.html at this placeholder, so CSS and click handlers can reach its zones.
...
def render_home():
    return render_with_map(HTML_PATH)
...
def serve_victory():
    return render_with_map(VICTORY_PATH)
